...
import { availableVersions, getRoutesFlatten, Version } from "@/lib/routes-config";
...
export default function VersionManager() {
  ...
  useEffect(() => {
    ...
    if (!pathname.startsWith("/docs") || isPathSameVersion(pathname, currentVersion)) return;
  ...
  return (
    <Select value={currentVersion} onValueChange={(v: Version) => changeVersion(v)}>
